...
import { students, users } from "../db/db.js";
...
export const checkEnroll = (
 ...
 const studentId = users.find((u:User) => u.studentId === payload?.studentId);

 if(studentId !== user.studentId  || user.role !== "STUDENT"){

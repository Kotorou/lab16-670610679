...
import { readDataFile, writeDataFile } from "../db/db_enrolltrans.js";
const router = Router();
...
router.get(
  ...
  (req: CustomRequest, res: Response) => {
    try {
      // get a all data from data in student and check which one is equal to enroll.studentId and store in enroll and in course store 
